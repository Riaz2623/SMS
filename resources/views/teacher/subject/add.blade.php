        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Add Subject From</h4>
                            ...
                            <form action="{{route('new-subject')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control summernote-simple" name="short_description" id="horizontal-password-input"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label for="horizontal-address-input" class="col-sm-3 col-form-label">Long Description </label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control summernote-simple" name="long_description" id="horizontal-password-input"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
