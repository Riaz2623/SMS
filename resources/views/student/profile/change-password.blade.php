                ...
                <div class="col-md-9">
                    <div class="card">
                        ...
                        <div class="card body">
                            ...
                            <form action="{{route('update-student-password',['id'=>$id])}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                {{--                                <div class="row mb-3">--}}
                                ...
                                <div class="row mb-3">
                                    <label class="col-md-3"></label>
                                    <div class="col-md-9">
                                        <input type="submit" value="Update Password Information" class="btn btn-outline-success" name="UPDATE">
                                    </div>
                                </div>
                            </form>
                        </div>
