...
class WebController extends Controller
{
    ...
    public function detail($id)
    {
       ...
       if (Session::get('student_id'))
       {
        ...
        return view('website.home.detail',['subject'=>$this->subject , 'check'=>$this->check]);
    }
    public function enroll($id)
    {
        ...
        {
            return view('website.home.enroll',['id'=>$id]);
        ...
        if($this->student)
        {
            ...
            if($this->enroll)
            {
                return redirect('/detail/'.$id)->with('message','You are already This course.Please try another course one. ');
            }
        }
        else
        {
        ...
        return redirect('/detail/'.$id)->with('message','Registration Successfully.');
    }
}
